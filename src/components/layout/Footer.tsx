                ...
                <div className="grid grid-cols-1 gap-8 md:grid-cols-12">
                    <div className="md:col-span-5">
                        ...
                        <ul className="mt-6 space-y-3 text-base text-slate-600">
                            <li className="flex items-center gap-3">
                                <Mail className="h-4 w-4 text-[#0aa39a]" />
                                <span>hello@servicehub.app</span>
                            </li>
                            <li className="flex items-center gap-3">
                                <Phone className="h-4 w-4 text-[#0aa39a]" />
                                <span>+1 (415) 555-0110</span>
                            </li>
                            <li className="flex items-center gap-3">
                                <MapPin className="h-4 w-4 text-[#0aa39a]" />
                                <span>22 Market Street, San Francisco</span>
                            </li>
                        </ul>

                        <div className="mt-6 flex items-center gap-3">
                            <a className="flex h-9 w-9 items-center justify-center rounded-full border border-slate-100 bg-white text-[#0aa39a] hover:bg-[#e8faf4] transition" href="#" aria-label="Facebook">
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" className="h-5 w-5 text-[#0aa39a]" aria-hidden>
                            ...
                            <a className="flex h-9 w-9 items-center justify-center rounded-full border border-slate-100 bg-white text-[#0aa39a] hover:bg-[#e8faf4] transition" href="#" aria-label="Instagram">
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" className="h-5 w-5 text-[#0aa39a]" aria-hidden>
                            ...
                            <a className="flex h-9 w-9 items-center justify-center rounded-full border border-slate-100 bg-white text-[#0aa39a] hover:bg-[#e8faf4] transition" href="#" aria-label="Twitter">
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" className="h-5 w-5 text-[#0aa39a]" aria-hidden>
                            ...
                            <a className="flex h-9 w-9 items-center justify-center rounded-full border border-slate-100 bg-white text-[#0aa39a] hover:bg-[#e8faf4] transition" href="#" aria-label="LinkedIn">
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" className="h-5 w-5 text-[#0aa39a]" aria-hidden>
                    ...
                    <div className="md:col-span-2">
                        ...
                        <ul className="space-y-2 text-base text-slate-600">
                            <li><Link href="/" className="hover:text-[#0aa39a]">Home</Link></li>
                            <li><Link href="/services" className="hover:text-[#0aa39a]">Services</Link></li>
                            <li><Link href="/providers" className="hover:text-[#0aa39a]">Providers</Link></li>
                            <li><Link href="/about" className="hover:text-[#0aa39a]">About</Link></li>
                            <li><Link href="/contact" className="hover:text-[#0aa39a]">Contact</Link></li>
                        </ul>
                    </div>
                ...
                <div className="mt-8 pt-6">
                    <div className="flex flex-col items-center justify-between gap-4 md:flex-row">
                        ...
                        <div className="flex items-center gap-4 text-base text-slate-600">
                            <Link href="#" className="hover:text-[#0aa39a]">Privacy</Link>
                            <Link href="#" className="hover:text-[#0aa39a]">Terms</Link>
                            <Link href="#" className="hover:text-[#0aa39a]">Cookies</Link>
                        </div>
                    </div>
                </div>
            </div>
